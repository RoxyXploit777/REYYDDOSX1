...
## Menu
![REYY](https://avatars.githubusercontent.com/u/115396895?v=4)
...
## Videos
[![](https://user-images.githubusercontent.com/87601386/161339371-b6dfaa8f-1cf2-41d1-85c1-d82cdd98def1.png)](https://www.youtube.com/tengkureyy777)
...
Install Chrome (or update it latest version)
...
Use command line : python3 main.py <method> <target> <thread> <time>
      └──────────> python3 main.py cfb https://example.com 443 60
```
